...
class TestPlanInputWindow(BoxLayout):
    ...
    def _create_test_plan_fields(self):
        ...
        fields = [
            ...
            ('Source Room SRS File', 'Source Room SRS File'),
            ('Receive Room SRS File', 'Receive Room SRS File'),
            ('Background Room SRS File', 'Background Room SRS File'),
            ('RT Room SRS File', 'RT Room SRS File'),
            ('Position 1 SRS File', 'Position 1 SRS File'),
            ('Position 2 SRS File', 'Position 2 SRS File'),
            ('Position 3 SRS File', 'Position 3 SRS File'),
            ('Position 4 SRS File', 'Position 4 SRS File'),
            ('Carpet SRS File', 'Carpet SRS File'),
            ('Tapper SRS File', 'Tapper SRS File'),
